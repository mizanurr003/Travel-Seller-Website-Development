...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        var swiperTesti = new Swiper(".testi-carousel", {
            ...
            speed: 600,
            navigation: {
                nextEl: '.testi-carousel .swiper-prev',
                prevEl: '.testi-carousel .swiper-next',
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        function scrollTopPercentage() {
            const scrollPercentage = () => {
                ...
                scrollElementWrap.css("background", `conic-gradient( var(--ts-color-theme-primary) ${scrollValue}%, var(--ts-color-common-white) ${scrollValue}%)`);
